...
import cm.andreson.arkamod.entity.SilentExplosion;
...
public class EntityDynamite extends EntityArrow implements cpw.mods.fml.common.registry.IThrowableEntity
{
  ...
  public EntityDynamite(World world, EntityLivingBase entityliving, int i, int type)
  {
    this(world);
  ...
  public void onUpdate()
  {
    ...
    if ((isInWater()) && (!this.extinguished))
    {
      ...
      {
        float f6 = 0.25F;
        this.worldObj.spawnParticle("explode", this.posX - this.motionX * f6, this.posY - this.motionY * f6, this.posZ - this.motionZ * f6, this.motionX, this.motionY, this.motionZ);
      }
    }
  ...
  public void onEntityUpdate()
  {
    ...
    if (aimRotation()) {
      ...
      this.rotationPitch = ((float)(Math.atan2(this.motionY, f2) * 180.0D / 3.141592653589793D));
  ...
  public void applyEntityHitEffects(Entity entity)
  {
    ...
    if ((entity instanceof EntityLivingBase)) {
      ...
      {
        ((EntityPlayerMP)this.shootingEntity).playerNetServerHandler.sendPacket(new net.minecraft.network.play.server.S2BPacketChangeGameState(6, 0.0F));
      }
    }
  }
  ...
  private void detonate()
  {
    ...
    if (this.type != NINJA) {
      ...
      SilentExplosion.newExplosion(this, this.posX, this.posY, this.posZ, f, false, false, this.worldObj);
  }
